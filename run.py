...
print("[DEBUG] WS Parser started (HARDCODED MODE)")

# === HARD CODED CONFIG ===
HOST = "10.80.24.101"      # Weather station IP
PORT = 502                 # Weather station TCP port
PACKET_SIZE = 25

# ---- MQTT HARDCODED SETTINGS ----
MQTT_HOST = "10.80.1.11"         # MQTT Broker IP/hostname
MQTT_PORT = 1883                 # MQTT Broker port
MQTT_USER = "mqtt_user"          # MQTT username, or "" if not used
MQTT_PASS = "mqtt_password"      # MQTT password, or "" if not used
MQTT_PREFIX = "weatherstation"   # MQTT topic prefix
DEBUG = True                     # Set True for verbose log
# ---------------------------------

print(f"[DEBUG] MQTT settings:")
